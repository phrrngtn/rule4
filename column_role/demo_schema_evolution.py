...
cols_t1 = desired_columns(reg, SRV, DB, "widget", T1)
...
cols_t2 = desired_columns(reg, SRV, DB, "widget", T2)
print(f"\nT2  column_role says widget = {cols_t2}")
added = reconcile_from_column_role(w, "widget", reg, SRV, DB, "widget", T2, snapshot_time=T2)
